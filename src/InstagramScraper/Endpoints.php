...
class Endpoints
{
    ...
    public static function getAccountMediaRequestCount()
    {
    ...
    public static function getMEdiaJsonByLocationIdLink($facebookLocationId, $maxId = '')
    {
    ...
    public static function getUserStoresLink($variables = [])
    {
        $url = self::getGraphQlUrl(InstagramQueryId::USER_STORES, ['variables' => json_encode($variables)]);
        return $url;
    }
